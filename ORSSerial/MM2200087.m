...
//    while ([joined hasPrefix:@"0"] && ![joined hasPrefix:@"0."]) joined = [joined substringFromIndex:1];
    ...
    _display = joined; // [@{ kLCD : joined, kFLAGS : _flags } jsonStringValue];
...
@synthesize onChange = _onChange __ port = _port ___ ///  history = _history ___

//- initWithOnChange { SUPERINIT ___
