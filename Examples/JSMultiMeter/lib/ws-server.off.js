...
wsServer.on('request', function(request) {
    ...
    setInterval(function() {
        ...
        var j = { 'msgtype' : 'data', 'sensortype':'temperature', 'sensorid':'123', 'value': sensorValue }
        connection.sendUTF(JSON.stringify(j)); // '{ "msgtype":"data", "sensortype":"temperature", "sensorid":"123", "value":"' + sensorValue + '" }');
    }, 500);
